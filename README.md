...
* fetch the built gem package located here: ```https://github.com/ProxiBlue/vagrant-communicator-docker/raw/master/communicator-docker-1.0.1.gem```
* install using: ```vagrant plugin install communicator-docker-1.0.1.gem```
